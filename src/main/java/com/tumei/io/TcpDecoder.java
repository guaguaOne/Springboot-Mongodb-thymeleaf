...
public class TcpDecoder extends ByteToMessageDecoder {
     ...
     */
    public TcpDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment,
     ...
     *            that exceeds <tt>maxFrameLength</tt> has been read.
     */
    public TcpDecoder(ByteOrder byteOrder, int maxFrameLength, int lengthFieldOffset, int lengthFieldLength,
    ...
    protected Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
        ...
        NettyMessage frame = NettyMessage.Decode(in.slice(readerIndex, actualFrameLength));
